...
export class ProfileComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.store.select("usersReducers").subscribe(userState => {
      ...
      this.setSurname = this.user.surname;
      this.setBirthdate = this.user.profile?.birthdate;
      this.setPhone = this.user.profile?.phone;
      this.setNationality = this.user.profile?.nationality;
      this.setNif = this.user.profile?.nif;
      this.setAbout = this.user.profile?.about;
      if (this.userType === 'company') {
        this.setCompany_name = this.user.profile?.company_name;
        this.setCompany_description = this.user.profile?.company_description;
        this.setCif = this.user.profile?.cif;
      }
    })
